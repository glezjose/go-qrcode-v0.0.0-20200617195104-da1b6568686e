...
func (m *regularSymbol) addFinderPatterns() {
	...
	m.symbol.set2dFinderPattern(0, 0, fp)
	m.symbol.set2dFinderPattern(0, fpSize, fpHBorder)
	m.symbol.set2dFinderPattern(fpSize, 0, fpVBorder)

	// Top right Finder Pattern.
	m.symbol.set2dFinderPattern(m.size-fpSize, 0, fp)
	m.symbol.set2dFinderPattern(m.size-fpSize-1, fpSize, fpHBorder)
	m.symbol.set2dFinderPattern(m.size-fpSize-1, 0, fpVBorder)

	// Bottom left Finder Pattern.
	m.symbol.set2dFinderPattern(0, m.size-fpSize, fp)
	m.symbol.set2dFinderPattern(0, m.size-fpSize-1, fpHBorder)
	m.symbol.set2dFinderPattern(fpSize, m.size-fpSize-1, fpVBorder)
}
